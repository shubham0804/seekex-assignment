export const Bars = ({ width = 30, height = 30, color, onClick }) => (
    <svg
        fill={color}
        width={width}
        height={height}
...
export const Search = ({ width = 30, height = 30, color }) => (
    <svg
        fill={color}
        width={width}
        height={height}
...
export const Favorites = ({ width = 30, height = 30, color }) => (
    <svg
        fill={color}
        width={width}
        height={height}
...
export const Cart = ({ width = 30, height = 30, color }) => (
    <svg
        fill={color}
        width={width}
        height={height}
...
export const Profile = ({ width = 30, height = 30, color }) => (
    <svg
        fill={color}
        width={width}
        height={height}
...
export const Share = ({ width = 30, height = 30, color }) => (
